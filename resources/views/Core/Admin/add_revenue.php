    ...
    if(isset($_POST['addRevenue']))
    {
            ...
            else
            {
               ...
               $description = $_POST['description'];
                ...
                $query="INSERT INTO LAMCorp_payments (pay_number, kiosk_number, litres_purchased, client_name, client_phone, till_number, transaction_code, amount, description) VALUES (?,?,?,?,?,?,?,?,?)";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc=$stmt->bind_param('sssssssss', $pay_number, $kiosk_number, $litres_purchased, $client_name, $client_phone, $till_number, $transaction_code, $amount, $description);
                $stmt->execute();

                //declare a varible which will be passed to alert function
                if($stmt)
                {
                 $success = "Payment Posted" && header("refresh:1; url=add_revenue.php");
                }
                else 
                {
                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><span>Add  Revenue</span></li>
                                </ol>
                            </nav>
                            ...
                            <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="widget-content widget-content-area">
                                        ...
                                        <button type="submit" name="addRevenue" class="btn btn-primary mt-3">Save</button>
                                        </form>
