<?php
    ...
    if(isset($_POST['addPayroll']))
    {
        ...
        if($stmt)
        {
            $success = "Payroll Added";// && header("refresh:1; url=add_staff.php");
        }
        else 
        {
                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><span>Add <?php echo $row->staff_name;?> Payrolls</span></li>
                                </ol>
                            </nav>
                                        ...
                                        <form method="post" enctype="multipart/form-data" >
                                            ...
                                            <div class="form-row mb-4">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input  required readonly type="text" name="staff_num" value="<?php echo $row->staff_num;?>" class="form-control" id="inputPassword4" placeholder="+254737229776">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required  name="salary"  class="form-control" id="inputAddress" >
                                                    </div>
                                                </div>                                   
                                            <div class="form-row">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea type="text"  name="comments" class="form-control" id="inputAddress" rows="10"></textarea>
                                            </div>

                                        <button type="submit" name="addPayroll" class="btn btn-primary mt-3">Add Payroll</button>
                                        </form>
