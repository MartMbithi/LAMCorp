<?php
    ...
    if(isset($_POST['addExpense']))
    {
            ...
            else
            {
                ...
                $query="INSERT INTO LAMCorp_expenses (exp_code, exp_type,exp_amt, exp_desc, kiosk_number) VALUES (?,?,?,?,?)";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc=$stmt->bind_param('sssss',  $exp_code, $exp_type, $exp_amt, $exp_desc, $kiosk_number);
                $stmt->execute();

                //declare a varible which will be passed to alert function
                if($stmt)
                {
                 $success = "Expense Added" && header("refresh:1; url=add_expenses.php");
                }
                else 
                {
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Add Expenses</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form method="post" enctype="multipart/form-data" >
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="kiosk_number" class="form-control  basic">
                                                    <option selected="selected">Select Kiosk Number Which The Expense Belongs To</option>
                                                    <?php
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required type="text"  name="exp_code" readonly value="LAMCorp-EXP-<?php echo $expenseCode;?>"  class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                      ...
                                      <button type="submit" name="addExpense" class="btn btn-primary mt-3">Save</button>
                                    </form>
