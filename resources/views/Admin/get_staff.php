                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-dark btn-sm" href="add_payrolls.php?staff_number=<?php echo $row->staff_num;?>&staff_id=<?php echo $row->staff_id;?>&staff_idno=<?php echo $row->staff_idno;?>">Create Payroll</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php }?>
