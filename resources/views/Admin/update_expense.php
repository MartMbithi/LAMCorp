   ...
   */
    if(isset($_POST['updateExpense']))
    {
        ...
        */
                ...
                $query="UPDATE LAMCorp_expenses SET exp_type=?, exp_amt=?, exp_desc=?, kiosk_number=? WHERE exp_id=?";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc=$stmt->bind_param('ssssi', $exp_type, $exp_amt, $exp_desc, $kiosk_number, $exp_id);
                $stmt->execute();
