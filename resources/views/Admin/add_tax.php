<?php
    ...
    if(isset($_POST['addTax']))
    {
            ...
            else
            {
                ...
                $query="INSERT INTO LAMCorp_taxes (tax_name, tax_rate, tax_code, tax_type) VALUES (?,?,?,?)";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc=$stmt->bind_param('ssss', $tax_name, $tax_rate, $tax_code, $tax_type);
                $stmt->execute();

                //declare a varible which will be passed to alert function
                if($stmt)
                {
                 $success = "Tax rate added" && header("refresh:1; url=add_tax.php");
                }
                else 
                {
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Add Rate</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                                    ...
                                    <form method="post" enctype="multipart/form-data" >
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required type="text"  name="tax_rate"  class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Tax Code</label>
                                                <input required type="text"  name="tax_code" readonly value="LAMCorp-Tax-<?php echo $taxNum;?>"  class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Tax Name</label>
                                                <input required type="text"  name="tax_name"  class="form-control">
                                            </div>
                                            
                                        </div>
                                      <button type="submit" name="addTax" class="btn btn-primary mt-3">Save</button>
                                    </form>
