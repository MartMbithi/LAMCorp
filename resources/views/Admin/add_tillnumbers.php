    ...
    */
    ...
    if(isset($_POST['addTillNo']))
    {
            ...
            else
            {
                ...
                $query="INSERT INTO LAMCorp_tills (till_service_provider, till_number) VALUES (?,?)";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc=$stmt->bind_param('ss', $till_service_provider, $till_number);
                $stmt->execute();

                //declare a varible which will be passed to alert function
                if($stmt)
                {
                 $success = "Till Number Added " && header("refresh:1; url=add_tillnumbers.php");
                }
                else 
                {
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Till Numbers</span></li>
                            </ol>
                        </nav>
                                    ...
                                    <form method="post" enctype="multipart/form-data" >
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="till_service_provider" class="form-control  basic">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required type="text"  name="till_number"  class="form-control">
                                            </div>
                                        </div>
                                      <button type="submit" name="addTillNo" class="btn btn-primary mt-3">Add Till Number</button>
                                    </form>
