                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Staff Records</span></li>
                            </ol>
                        </nav>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><a href="view_staff.php?staff_number=<?php echo $row->staff_num;?>"><?php echo $row->staff_name;?></a></td>
