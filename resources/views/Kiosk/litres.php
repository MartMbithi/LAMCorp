                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Water Litres Sold</span></li>
                            </ol>
                        </nav>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $ret="SELECT * FROM  LAMCorp_payments WHERE kiosk_number =? ORDER BY `LAMCorp_payments`.`created_at` DESC "; 
